"""
Django settings for DaniKart project.
...
# ALLOWED_HOSTS = config.list('ALLOWED_HOSTS')  # This is the allowed hosts, it is used to allow the host to access the website
ALLOWED_HOSTS = []
...
WSGI_APPLICATION = 'DaniKart.wsgi.application'
...
# scp -i C:\Users\DanishIrfan\Downloads\Danikhan.pem E:\Django\DaniKart\.env* user@public-dns-name:/home/ubuntu/Ecommerce-Django-Bootstrap-Project
